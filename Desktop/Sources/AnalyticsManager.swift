...
class AnalyticsManager {
    ...
    /// Track when Ask Fazm is opened (AI input panel shown)
    func floatingBarAskFazmOpened(source: String) {
        let props: [String: Any] = ["source": source]
        MixpanelManager.shared.track("Floating Bar Ask Fazm Opened", properties: props.compactMapValues { $0 as? MixpanelType })
    ...
    func floatingBarAskFazmClosed() {
        MixpanelManager.shared.track("Floating Bar Ask Fazm Closed")
